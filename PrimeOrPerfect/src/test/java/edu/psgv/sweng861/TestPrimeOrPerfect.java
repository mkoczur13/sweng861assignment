...
class TestPrimeOrPerfect {
	...
	public void analyzePrimeNumber() {
		assertEquals(NumberType.PRIME,
		PrimeOrPerfect.analyzeNumber(499));
	}
	
	@Test
	// test the analyzeNumber method with perfect numbers.
	public void analyzePerfectNumbers() {
		assertEquals(NumberType.PERFECT, PrimeOrPerfect.analyzeNumber(
		6));
		assertEquals(NumberType.PERFECT, PrimeOrPerfect.analyzeNumber(
		28));
		assertEquals(NumberType.PERFECT,
		PrimeOrPerfect.analyzeNumber(496));
	}
	
	@Test
	// test the analyzeNumber method with ordinary numbers.
	public void analyzeOrdinaryNumbers() {
		assertEquals(NumberType.ORDINARY, PrimeOrPerfect.analyzeNumber(
		4));
		assertEquals(NumberType.ORDINARY, PrimeOrPerfect.analyzeNumber(
		27));
		assertEquals(NumberType.ORDINARY,
		PrimeOrPerfect.analyzeNumber(498));
	}
